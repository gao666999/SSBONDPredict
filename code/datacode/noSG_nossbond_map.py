...
# t0 = time.time()
pdb_list = os.listdir('/Users/dongxq/Desktop/SSBOND_supplement/newdataset40/')
print 'pdb numbers',len(pdb_list)
if pdb_list[0] =='.DS_Store': 
	pdb_list = pdb_list[1:]
# print 'pdb numbers',len(pdb_list)
pdb_namefile=os.path.join('/Users/dongxq/Desktop/SSBOND_supplement/rootpath40','pdb_name_noss.txt')
...
for pdb in pdb_list:
	...
	with open('/Users/dongxq/Desktop/SSBOND_supplement/newdataset40/%s'%pdb,'r') as f:
		...
		for line in f:
			...
			if temp == 'SSBOND' and SSchainid==PDBchainid:
				#print line_temp
				#print line_temp[4][-1].isalpha(),'eeeeeeeeeeeeeee'
...
print nossbond_map
resultnpy='/Users/dongxq/Desktop/SSBOND_supplement/rootpath40/negative_nossbonds_map.npy'
